...
<head>
  ...
  <title>Student registration fee invoice</title>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            @php
                $reg_fee = App\Models\FeeAmount::where('fee_category_id','2')->where('class_id',$details->class_id)->first();
