...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <h4 style="font-weight: bold; padding-top:-25px; text-align:center">Student Monthly Fee</h4>
        </div>
        <div class="col-md-12">

            @php
                $monthly_fee = App\Models\FeeAmount::where('fee_category_id','3')->where('class_id',$details->class_id)->first();
            ...
            <table width="100%" border="1">
                <tbody>
                    ...
                    <tr>
                        <td> Fee (This student ) of {{$month}}</td>
                        <td>{{$final_fee}} TK</td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <h4 style="font-weight: bold; padding-top:-25px; text-align:center">Student Registration Fee</h4>
        </div>
        <div class="col-md-12">
