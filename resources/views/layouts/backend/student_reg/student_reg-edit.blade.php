...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Update Student Registration</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            ...
            <div class="card-body">
              <form action="{{ route('registration.update',$editData->student_id)}}" method="post" id="quickForm"  enctype="multipart/form-data"> 
                @csrf
                @method('PUT')
