          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form action="{{ route('fee.update',$editFee->id)}}" method="post" id="quickForm"> 
                  @csrf
                  @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="fee_name" value="{{$editFee->fee_name}}" class="form-control" placeholder="Fee Name ...">
