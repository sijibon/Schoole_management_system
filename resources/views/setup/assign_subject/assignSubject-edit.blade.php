...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
            <form action="{{ route('assignSubject.update',$assignSubjects[0]->class_id)}}" method="post" id="quickForm" enctype="multipart/form-data"> 
            @csrf
            @method('PUT')
            <div class="add_item">
              <div class="form-row">
                  <div class="col-sm-3">
                      <div class="form-group">
                          ...
                          <select name="class_id" class="form-control">
                              ...
                              <option value="{{$item->id}}" {{($item->id == $assignSubjects[0]->class_id)? 'selected': '' }}>{{$item->class_name}}</option>
                              @endforeach
                          </select>
              ...
              @foreach ($assignSubjects as $edit)
                ...
                <div class="form-row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select name="subject_id[]" class="form-control">
                                ...
                                <option value="{{$item->id}}" {{($edit->subject_id == $item->id) ? 'selected':''}}>{{$item->subject_name}}</option>   
                                @endforeach
                            </select>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="full_mark[]" value="{{$edit->full_mark}}" class="form-control" placeholder="Full Mark ...">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="pass_mark[]" value="{{$edit->pass_mark}}" class="form-control" placeholder="Pass Mark ...">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="subjective_mark[]" value="{{$edit->subjective_mark}}" class="form-control" placeholder="subjective mark ...">
