          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form action="{{ route('designation.store')}}" method="post" id="quickForm"> 
                  @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                              <label>Designation Name</label>
                              <input type="text" name="desig_name" class="form-control" placeholder="Designation Name ...">
...
<script>
    $(function () {
      $('#quickForm').validate({
        ...
        messages: {
          desig_name: {
            required: "Please enter designations name",
            desig_name: "Please enter a unique designations name"
          },
