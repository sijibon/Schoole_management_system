          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form action="{{ route('examType.update',$exam_edit->id)}}" method="post" id="quickForm"> 
                  @csrf
                  @method('PUT')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="exam_name" value="{{$exam_edit->exam_name}}" class="form-control" placeholder="Exam Name ...">
