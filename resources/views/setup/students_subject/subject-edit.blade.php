          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form action="{{route('subject.update', $editSubject->id)}}" method="post" id="quickForm"> 
                @csrf
                 @method('PUT')           
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" value="{{$editSubject->subject_name}}" name="subject_name" class="form-control" placeholder="Subject Name ...">
