          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <form action="{{route('users.update',$editUser->id)}}" method="post" id="quickForm">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Name</label>
                          <input type="text" name="name" class="form-control" value="{{$editUser->name}}" placeholder="Name ...">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          <label>Email</label>
                          <input type="email" name="email" value="{{$editUser->email}}" class="form-control" placeholder="Email ...">
                        </div>
                      </div>
                   </div>
