...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
            <form action="{{ route('fee_amount.update',$fee_amount_edits[0]->fee_category_id)}}" method="post" id="quickForm" enctype="multipart/form-data"> 
            @csrf
            @method('PUT')
                <div class="add_item">
                    <div class="form-row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select name="fee_category_id" class="form-control">
                                    ...
                                    <option value="{{$category->id}}" {{($fee_amount_edits[0]->fee_category_id==$category->id? 'selected':'')}}>{{$category->fee_name}}</option>
                                    @endforeach
                                </select>
                    ...
                    @foreach ($fee_amount_edits as $edit)
                        ...
                        <div class="form-row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <select name="class_id[]" class="form-control">
                                        ...
                                        <option value="{{$item->id}}" {{($edit->class_id == $item->id? 'selected': '')}}>{{$item->class_name}}</option>   
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount[]" value="{{$edit->amount}}" class="form-control" placeholder="Fee Amount ...">
